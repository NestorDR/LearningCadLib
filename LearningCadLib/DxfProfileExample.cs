...
namespace LearningCadLib
{
    internal class DxfProfileExample : DxfBase
    {
        ...
        internal override string Draw()
        {
            ...
            const int drawsToAdd = 3;

            // Draw a circle keeping aspect ratio with the profile/container
            double x = profileLength / drawsToAdd / 2;          // Centers on the area that is the first third of the abscissa (of the profile)
            ...
            x = x + profileLength / drawsToAdd - length / 2;   // Centers on the area that is the second third of the abscissas (of the profile)
            ...
            x += profileLength / drawsToAdd;                    // Centers on the second third of the abscissas (of the profile)
